...
Report bugs at https://github.com/apehex/adviz/issues.
...
The best way to send feedback is to file an issue at https://github.com/apehex/adviz/issues.
...
Ready to contribute? Here's how to set up `adviz` for local development.

1. Fork the `adviz` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/adviz.git
...
3. The pull request should work for Python 2.7, 3.5, 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/apehex/adviz/pull_requests
